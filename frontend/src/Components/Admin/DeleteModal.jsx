export default function DeleteModal({onClose, onDelete}) {
  return(
    <main className="bg-white p-5 w-100 rounded-md">
      ...
      <p className="text-lg">Are you sure you want to delete this cottage?</p>
      <div className="flex items-center justify-end gap-3 mt-6">
        <button onClick={onClose} className="bg-gray-300 px-4 py-1.5 rounded-md">Cancel</button>
        <button onClick={onDelete} className="bg-red-500 text-white px-4 py-1.5 rounded-md">Delete</button>
      </div>
    </main>
  )
}