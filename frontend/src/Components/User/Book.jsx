      ...
      <div className='border border-gray-300 rounded-2xl bg-white shadow-lg p-6'>
        ...
        <div className='mt-8'>
          ...
          <div className='flex items-center gap-8 mt-4'>
            ...
            <button onClick={() => setCapacity(c => c < cottage?.Capacity ? c + 1 : cottage?.Capacity)} className='border border-gray-400 rounded-full p-2'><Plus size={18}/></button>
            <p className='text-gray-500'>Max: {cottage?.Capacity}</p>
          </div>
        </div>
