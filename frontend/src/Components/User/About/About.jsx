      ...
      <div className="flex items-center justify-center h-90 bg-cover bg-center bg-no-repeat relative"
        style={{
          ...
          <div className="text-center relative z-10">
            <h1 className="text-5xl font-bold text-white">About Serenity Resort</h1>
            <p className="text-xl mt-2 text-white">Discover the perfect getaway at our serene resort</p>
          </div>
        </div>
        ...
        <div className="px-20 py-6">
          <section className="grid grid-cols-2 gap-10 mt-10">
            <div>
              ...
              <div className="mt-4 text-gray-700 space-y-4 text-lg">
          ...
          <section className="mt-20 bg-white p-10 rounded-lg shadow-lg">
            <h1 className="text-3xl font-semibold mb-10 text-center">Why Choose Serenity Resort?</h1>
