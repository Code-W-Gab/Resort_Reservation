...
export const confirmReservation = (id) => api.put(`/reserve/update/${id}`, { Status: "Confirmed" })
export const cancelReservation = (id) => api.put(`/reserve/update/${id}`, { Status: "Cancelled" })